...
class BayesianLinearRegression:
    ...
    def update_posterior(self, phi, actions, targets, PhiPhiT, PhiY):
        ...
        # print("one hot actions: " ,one_hot_actions.shape)
...
"""
    ...
    for global_step in range(args.total_timesteps):
        ...
        if global_step % 100 == 0:
            ...
            writer.add_scalar("exploration/selected_q_values", q_values.max().item(), global_step)
        if terminations:
            ...
            wandb.log({"reward-reached": state_coverage[obs_dim-1][obs_dim-1].item()})
    ...
    if args.track:
        ...
        wandb.summary["state-matrix"] = state_coverage.tolist()
